...
class MyFlowersCollectionView:   UICollectionView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.nameLabel.text = NSLocalizedString(cells[indexPath.row].flowerName, comment: "")
        return cell
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
       print("hello2")
        ...
        selectedPlant = cells[indexPath.row].flowerName
